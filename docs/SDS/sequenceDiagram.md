...
> 채팅 도메인의 의도 분류·라우팅 스펙(COMPOSE 워크플로는 **미채택/retired**, 폐기된 설계)은 [aiPipelineDesign §5.3](./aiPipelineDesign.md), 의도별 단계 매핑은 [classDiagram §chatPipeline](./classDiagram/chatPipelineClassDiagram.md) 참고.
