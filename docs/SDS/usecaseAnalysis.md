...
| **외부 서비스** | LLM(prod VLM 관찰=Bedrock Claude Haiku 4.5 · 코칭=Grok · 이미지=Bedrock Stability; Gemini=dev 전용 `VLM_BACKEND=aistudio`), Pinecone, Qdrant, Bedrock(Stability), Google OAuth, SMTP, fastapi(embed·guide). |
