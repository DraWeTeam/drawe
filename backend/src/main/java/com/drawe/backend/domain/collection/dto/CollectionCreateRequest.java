...
/**
 * 새 컬렉션 생성 — SCR-ARCH-05 '아카이브 추가(+)'로 새 컬렉션 만들며 담기, 또는 SCR-ARCH-02 '직접 추가하기'로 업로드 이미지를 담아 생성.
 * imageIds 는 선택(빈 컬렉션도 허용). 저장 흐름에서 만든 사용자 컬렉션이므로 axis=null·is_system=false.
 */
