...
public class EmailVerificationService {
    ...
    private String cooldownKey(String email) {return "email:verify:cooldown:"+email;}
    private String attemptsKey(String email) {return "email:verify:attempts:"+email;}
    private String verifiedKey(String email) {return "email:verify:verified:"+email;}
