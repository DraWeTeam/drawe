...
public class ProjectKeywordService {
  ...
  private static final String EXTRACT_PROMPT =
      ...
      문장에 있는 주제/사물뿐 아니라, 그 장면에서 자연스럽게 연상되는 분위기 형용사를 반드시 함께 포함해라(색감·구도가 자연스러우면 넣어도 좋다).
      규칙: 명사는 조사(의·이·가·을·를·은·는·에 등) 없이 단어만("봄의"❌→"봄"⭕, "여성이"❌→"여성"⭕), 형용사는 '~한/은/인' 형태 유지. 최대 %d개. "그려줘/찾아줘" 요청 동사와 "앉아 있는" 같은 서술어구는 제외.
      설명·코드펜스 없이 JSON 문자열 배열만 반환.

      예)
      주제: 햇빛이 드는 카페의 창가에 앉아있는 여성
      → ["따뜻한","밝은","카페","창가","여성"]
      주제: 비 오는 밤 도시의 네온사인 거리
      → ["몽환적인","어두운","고요한","네온","도시","거리"]
      """
