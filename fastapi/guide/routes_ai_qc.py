...
main.py 를 덮어쓰지 않도록 별도 라우터로 분리했다. main.py 에 두 줄만 추가하면 붙는다:
    ...
    from guide.routes_ai_qc import router as ai_qc_router      # 다른 import 들과 함께
...
from guide.pipeline.ai_ingest import qc_and_ingest, MEDIUMS
from guide.pipeline.profiles import PROFILES
