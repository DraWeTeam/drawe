...
실행:
    docker compose exec -w /app guide python scripts/probe_composition.py
추가 후보 직접 넣기:
    docker compose exec -w /app guide python scripts/probe_composition.py "my new phrasing"
