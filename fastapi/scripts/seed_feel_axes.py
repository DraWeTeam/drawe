...
실행(컨테이너 — 인터넷 + 인프라):
  docker compose exec -w /app guide python scripts/seed_feel_axes.py            # 쿼리당 20장
  docker compose exec -w /app guide python scripts/seed_feel_axes.py 40         # 쿼리당 40장
...
from seed_museum import _seed_query  # 단건 시더 재사용
